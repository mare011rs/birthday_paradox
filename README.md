...
We intuitively think that because there are 365 days in the year we would need half of that number in the amount of people to achieve the 50% chance of matching birthdays, but the trick is that everybody is being compared with everybody and we are checking for matches between each person. This quickly increases the number of comparisons by each person added to the group, increasing the probability of a match.
